...
public partial class RentalApplication
{
    ...
    public static RentalApplication FullTestApplication =>
        new()
        {
            ...
            OtherIncomeExplain =
                "I receive $500 monthly from investments and a trust fund that pays $1200 quarterly.",
            ...
            CurrentRental = new RentalReference
            {
                ...
                ReasonForMoving =
                    "Seeking a larger apartment with more amenities and closer to work.",
            },
            ...
            ExplainCriminalRecord =
                "One minor parking violation in 2020 that resulted in community service.",
            HasBeenEvicted = YesNo.Yes,
            ExplainBeenEvicted =
                "There was an error with my previous apartment building's management in 2017 where they incorrectly processed an eviction notice, but it was resolved and removed from my record.",
            ...
            AnyPets = YesNo.Yes,
            DescribePets =
                "One cat named Luna, 3 years old, spayed, indoor only, 7 pounds, domestic short hair.",
            AnyNonHuman = YesNo.Yes,
            DescribeNonHuman =
                "One 10-gallon freshwater aquarium with 5 small fish (neon tetras and guppies).",
            ...
            DescribeReasonableAccommodation =
                "I have occasional migraines and would prefer a unit away from high-traffic or noisy areas if possible.",
            AcceptedTerms = true,
            AdditionalComments =
                "I'm a registered nurse working the day shift at Portland City Hospital. I'm looking for a quiet apartment close to work and public transportation. I'm a responsible tenant with a stable income and excellent rental history.",
        };

    public static RentalApplication MinimalTestApplication =>
        new()
        {
            RentalAddress = "1234 Apartment Way, Apt #301, Portland, OR 97201",
            PersonalInfo = new PersonalInfo
