...
public partial class RentalApplication
{
    ...
    public RentalReference CurrentRental { get; set; } =
        new RentalReference()
        {
            DisplayName =
                "Two year's rental references preferred. Please list your actual landlord, property manager, or RA.",
            ElectiveRequireValue = YesNo.Yes,
        };

    public EmploymentInfo PrimaryEmployment { get; set; } =
        new EmploymentInfo()
        {
    ...
    public EmploymentInfo SecondaryEmployment { get; set; } =
        new EmploymentInfo()
        {
    ...
    public ParentInfo ParentInfo { get; set; } =
        new ParentInfo() { DisplayName = "Parent Information" };
    ...
    [RequireIfEnum(
        nameof(ConsiderOtherIncome),
        YesNo.Yes,
        "Please explain your other sources of income"
    )]
    ...
    public RentalReference PriorRentRef1 { get; set; } =
        new RentalReference()
        {
    ...
    public PersonalReference PersonalReference1 { get; set; } =
    ...
    public PersonalReference PersonalReference2 { get; set; } =
        new PersonalReference()
        {
    ...
    [Required(
        ...
        ErrorMessage = "Please indicate your anticipated length of stay"
    )]
    ...
    [Display(
        Name = "Has anyone applying ever had their lease agreement terminated or been evicted?"
    )]
    [EnumDataType(typeof(YesNo))]
    ...
    [Display(
        Name = "Do any applicants have or anticipate obtaining a Medical Marijuana Caregiver or Patient card designation?"
    )]
    [EnumDataType(typeof(YesNo))]
    [Required(
        ErrorMessage = "Please indicate if any applicants have or anticipate obtaining a Medical Marijuana card"
    )]
    ...
    [RangeIfEnum(
        ...
        nameof(Drinkers),
        YesNo.Yes,
        "Please indicate how often residents drink"
    )]
    ...
    [Display(
        Name = "Will there be any animals, birds, reptiles, insects, fish, or other non-human life forms living on or in the premises?"
    )]
    [EnumDataType(typeof(YesNo))]
    ...
    [RequireIfEnum(
        nameof(AnyNonHuman),
        YesNo.Yes,
        "Please provide details about the non-human life forms"
    )]
    ...
    [RangeIfEnum(
        ...
        1,
        "20.0",
        nameof(AttendCollege),
        YesNo.Yes,
        "Please enter how many years you've attended college"
    )]
    ...
    [DataType(DataType.MultilineText)]
    [RequireIfEnum(
        nameof(NeedReasonableAccommodation),
        YesNo.Yes,
