...
{
    public static RentalApplication ToDomainModel(this ApplicationViewModel src) =>
        new(
            ...
            NeedReasonableAccommodation: src.NeedReasonableAccommodation.MapEnum<
                YesNoViewModel,
                YesNo
            >(),
    ...
    public static ApplicationViewModel ToViewModel(this RentalApplication src) =>
        new()
        {
            RentalAddress = src.RentalAddress,
            OtherApplicants = src.OtherApplicants,
