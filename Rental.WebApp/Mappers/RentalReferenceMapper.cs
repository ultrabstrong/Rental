...
internal static class RentalReferenceMapper
{
    public static RentalReference ToDomainModel(this RentalReferenceViewModel src) =>
        new(
    ...
    public static RentalReferenceViewModel ToViewModel(this RentalReference src) =>
        new()
        {
            AllowElectiveRequire = src.AllowElectiveRequire,
            ElectiveRequireDisplay = src.ElectiveRequireDisplay,
